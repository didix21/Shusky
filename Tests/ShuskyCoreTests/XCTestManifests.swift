...
extension CommandTests {
    ...
    static let __allTests__CommandTests = [
        ("testCustomSwiftRun", testCustomSwiftRun),
        ("testDefaultSwiftRun", testDefaultSwiftRun),
        ...
        ("testShouldAvoidAddingCurrentPath_WhenRunningBinary", testShouldAvoidAddingCurrentPath_WhenRunningBinary),
        ("testShouldRunBinary", testShouldRunBinary),
        ("testShouldRunDebugBinary_WithBuildPath", testShouldRunDebugBinary_WithBuildPath),
        ("testShouldRunDebugBinary_WithPackagePath", testShouldRunDebugBinary_WithPackagePath),
        ("testShouldRunReleaseBinary_WithBuildPath", testShouldRunReleaseBinary_WithBuildPath),
        ("testShouldRunReleaseBinary_WithPackagePath", testShouldRunReleaseBinary_WithPackagePath),
    ]
}
...
extension SwiftRunTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__SwiftRunTests = [
        ("testCustomSwiftRun", testCustomSwiftRun),
        ("testDefaultSwiftRun", testDefaultSwiftRun),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(SwiftRunTests.__allTests__SwiftRunTests),
    ]
}
#endif
